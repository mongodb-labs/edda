...
def test_process():
    ...
    # valid lines
    check_state("Mon Jun 11 15:56:16 [rsStart] replSet I am 10.4.65.7:27018", "STARTUP1", 0, "localhost:27018")
...
def test_startup_with_IP():
    ...
    a STARTUP message"""
    doc = process("Mon Jun 11 15:56:16 [rsStart] replSet I am 10.4.65.7:27018", datetime.now())
    assert doc
...
def test_startup_with_hostname():
    ...
    doc = process("Mon Jun 11 15:56:16 [rsStart] replSet I am sam@10gen.com:27018", datetime.now())
    assert doc
    assert doc["type"] == "status"
    assert doc["info"]["state_code"] == 0
    assert doc["info"]["state"] == "STARTUP1"
