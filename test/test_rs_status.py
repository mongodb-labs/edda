...
def test_process():
    ...
    # valid lines
    check_state("Mon Jun 11 15:56:16 [rsStart] replSet I am", "STARTUP1", 0, "self")
...
def test_startup_with_IP():
    ...
    a STARTUP message"""
    check_state_with_addr("Mon Jun 11 15:56:16 [rsStart] replSet I am 10.4.65.7:27018", "STARTUP1", 0, "10.4.65.7:27018")


def test_startup_with_hostname():
    """Test that program captures hostnames from
    STARTUP messages as well as IP addresses"""
    check_state_with_addr("Mon Jun 11 15:56:16 [rsStart] replSet I am sam@10gen.com:27018", "STARTUP1", 0, "sam@10gen.com:27018")
